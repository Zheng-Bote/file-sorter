#!/usr/bin/bash
# =============================================================================
# SPDX-FileComment: Script for creating a Linux AppImage package (Modern way)
# SPDX-FileType: SOURCE
# SPDX-FileContributor: ZHENG Robert
# SPDX-FileCopyrightText: 2026 ZHENG Robert
# SPDX-License-Identifier: MIT
#
# @file create_appimage_modern.sh
# @brief Modern script to build and package FileSorter into an AppImage on Linux.
# @version <1.2.1>
# @date <2026-03-04>
#
...
export LD_LIBRARY_PATH="$PROJECT_DIR/build_appimage/AppDir/usr/lib:$LD_LIBRARY_PATH"
